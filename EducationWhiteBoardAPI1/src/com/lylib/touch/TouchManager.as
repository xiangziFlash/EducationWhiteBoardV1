...
//				}
		...
		{
			//trace("removeBlob------", touchID, obj.name);
			for each(var manager:TouchManager in OSMultiTouch.getInstance().objTouchManagerDict)
			{
				manager.removePoint(touchID);
			}
		}
		
		
		public function removePoint(touchID:int) : void
		{
