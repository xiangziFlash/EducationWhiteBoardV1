package com.events 
{
	 ...
	 * @author wang
	 */
	public class PageMoveSpriteEvent extends Event 
	{
		/**
		 * 当显示子项被点击后
		 */
		...
		public function PageMoveSpriteEvent(type:String, bubbles:Boolean=false, cancelable:Boolean=false) 
		{ 
		...
		{ 
			return new PageMoveSpriteEvent(type, bubbles, cancelable);
		} 
		
		public override function toString():String 
		{ 
			return formatToString("PageMoveSpriteEvent", "type", "bubbles", "cancelable", "eventPhase"); 
		}
