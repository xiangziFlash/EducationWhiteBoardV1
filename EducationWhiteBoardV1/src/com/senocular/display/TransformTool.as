	...
	public class TransformTool extends Sprite {
		...
		private function addToolControl(container:Sprite, control:TransformToolControl, interactive:Boolean = true):void {
			...
			if (interactive) {
				...
				control.addEventListener(MouseEvent.DOUBLE_CLICK, controlDoubleClick);	
			}
		...
		private function controlDoubleClick(e:MouseEvent):void
		{
			trace("双击被激发");
			dispatchEvent(new Event(CONTROL_CLOSE));
		}
